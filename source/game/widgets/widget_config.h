...
STRINGY_ENUM( WidgetType,
	...
	SROLLBAR_BTN_UP, SROLLBAR_BTN_DOWN, SROLLBAR_BTN_LEFT, SROLLBAR_BTN_RIGHT,
	SROLLBAR_VERT_SHAFT, SROLLBAR_VERT_THUMB, SROLLBAR_HORIZ_SHAFT, SROLLBAR_HORIZ_THUMB,
