...
Config::Config(const char* fileName) {
	...
	uiLastProductionDisplayPosX = p->getInt("UiLastProductionDisplayPosX", -1);
	uiLastProductionDisplayPosY = p->getInt("UiLastProductionDisplayPosY", -1);
	uiLastProductionDisplaySize = p->getInt("UiLastProductionDisplaySize", 1, 1, 3);
	uiLastStatsDisplayPosX = p->getInt("UiLastStatsDisplayPosX", -1);
	uiLastStatsDisplayPosY = p->getInt("UiLastStatsDisplayPosY", -1);
	uiLastStatsDisplaySize = p->getInt("UiLastStatsDisplaySize", 1, 1, 3);
	uiLastCarriedDisplayPosX = p->getInt("UiLastCarriedDisplayPosX", -1);
	uiLastCarriedDisplayPosY = p->getInt("UiLastCarriedDisplayPosY", -1);
	uiLastCarriedDisplaySize = p->getInt("UiLastCarriedDisplaySize", 1, 1, 3);
	uiLastResourcesDisplayPosX = p->getInt("UiLastResourcesDisplayPosX", -1);
	uiLastResourcesDisplayPosY = p->getInt("UiLastResourcesDisplayPosY", -1);
	uiLastResourcesDisplaySize = p->getInt("UiLastResourcesDisplaySize", 1, 1, 3);
	uiLastEventDisplayPosX = p->getInt("UiLastEventDisplayPosX", -1);
	uiLastEventDisplayPosY = p->getInt("UiLastEventDisplayPosY", -1);
	uiLastEventDisplaySize = p->getInt("UiLastEventDisplaySize", 1, 1, 3);
...
void Config::save(const char *path) {
	...
	p->setInt("UiLastEventDisplayPosX", uiLastEventDisplayPosX);
	p->setInt("UiLastEventDisplayPosY", uiLastEventDisplayPosY);
	p->setInt("UiLastEventDisplaySize", uiLastEventDisplaySize);
