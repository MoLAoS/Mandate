...
public:
	...
	*/
	virtual void Print( FileOps *f, int depth ) const = 0;
...
public:
	...
	*/
	...
	virtual void Print( FileOps *f, int depth ) const {
		Print( f, depth, 0 );
	}
	void Print( FileOps *f, int depth, TIXML_STRING* str ) const;
...
public:
	...
	virtual void Print( FileOps *f, int depth, TIXML_STRING* str ) const;
	virtual void Print( FileOps *f, int depth ) const {
		Print( f, depth, 0 );
	}
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	virtual void Print(FileOps *f, int depth = 0 ) const;
	// [internal use]
